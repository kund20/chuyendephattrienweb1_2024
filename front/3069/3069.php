...
<head>
    ...
    <link rel="stylesheet/less" type="text/css" href="less/3069.less">
    <link rel="stylesheet" href="css/3069.css">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 main-content">
                <div class="dev-license">
                    <strong>Dev License:</strong> This installation of WHMCS is running under a Development License and
                    is not authorized to be used for production use. Please report any cases of abuse to abuse@whmcs.com
                </div>
            </div>
        </div>
        <h2>News</h2>
        <div class="news-container">
            ...
            <div class="announcement-single">
                <h3>
                    ...
                    <a href="">Thank you for choosing WHMCS 7 Templates !</a>
                </h3>
